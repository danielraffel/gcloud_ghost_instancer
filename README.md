...
This installer is compatible with Ghost v6. It configures Node 22 during setup to satisfy Ghost v6’s Node requirement.
...
* Ghost v6 support: the installer sets up Node 22 automatically during the install
